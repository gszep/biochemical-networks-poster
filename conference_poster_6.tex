...
\begin{minipage}[b]{0.99\linewidth}
	\begin{center}
		...
		\huge \textbf{Gregory Sz\'ep$^1$, Attila Csik\'asz-Nagy$^1$, Luca Cardelli$^2$}\\[0.5cm] % Author(s)
		\huge $^1$King's College London $^2$Microsoft Research\\[0.4cm] % University/organization
