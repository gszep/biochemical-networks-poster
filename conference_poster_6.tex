...
\begin{tikzpicture}[remember picture, overlay]
	\node [anchor=south west, inner sep=6cm]  at (0,-17) {
		\includegraphics[height=12cm]{pattern}};
\end{tikzpicture}

\begin{tikzpicture}[remember picture, overlay]
	\node [anchor=south west, inner sep=6cm]  at (25,-15) {
		\includegraphics[height=12cm]{geometrisation}};
\end{tikzpicture}

\begin{tikzpicture}[remember picture, overlay]
	\node [text width=12cm] at (59,-2) {
		\begin{align*}
...
\begin{tikzpicture}[remember picture, overlay]
	\node [anchor=south west, inner sep=6cm]  at (15,-6) {
		\includegraphics[height=2cm]{rarrow}};
\end{tikzpicture}

\begin{tikzpicture}[remember picture, overlay]
	\node [text width=24cm]  at (32,1) {
		\textbf{\textcolor{Gray}{geometrisation}}};
\end{tikzpicture}

\begin{tikzpicture}[remember picture, overlay]
	\node [anchor=south west, inner sep=6cm]  at (38,-2) {
		\includegraphics[height=2cm]{rarrow}};
\end{tikzpicture}

\begin{tikzpicture}[remember picture, overlay]
	\node [text width=24cm]  at (57,5) {
		\textbf{\textcolor{Gray}{inference}}};
\end{tikzpicture}

\begin{tikzpicture}[remember picture, overlay]
	\node [text width=12cm] at (34,7) {
		\begin{align*}\textcolor{red}{\bar{\mathrm{R}}}\end{align*}};
\end{tikzpicture}

\begin{tikzpicture}[remember picture, overlay]
	\node [text width=12cm] at (36.5,9.75) {
